...
export default class AdditionalDocsComponent extends React.Component{
    state={
        isError:false,
    ...
    render(){
        ...
        return <div className=" container certificate-container">
         <div className="row align-items-center">      
            <div className="flex-grow-1">
                <div className="text-center">
                <span className="text-style">Additional Documents</span>  
                </div>
            </div>
            <div className="">
